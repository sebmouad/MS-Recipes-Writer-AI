...
msrwa_test_assert( 10 === count( $lab_prompts ), 'One maintained prompt per step that calls a model — four text stages, two image stages and the final approval — plus the research written from the editor’s photographs, and the collage’s brief and composing instruction.' );
