...
final class MSRWA_Admin {
	...
	public static function settings_page() {
		...
		<section class="msrwa-card" id="msrwa-settings-output"><h2>Pagination et images</h2><h3>Pagination des articles</h3><p><label><input type="checkbox" name="<?php echo esc_attr( MSRWA_Settings::FORM_FIELD ); ?>[article_pagination_enabled]" value="1" <?php checked( $s['article_pagination_enabled'], 1 ); ?>> Diviser les articles en deux pages WordPress</label></p><div class="msrwa-fields"><label>Mots minimum pour division<input type="number" min="300" max="8000" name="<?php echo esc_attr( MSRWA_Settings::FORM_FIELD ); ?>[article_pagination_min_words]" value="<?php echo esc_attr( $s['article_pagination_min_words'] ); ?>"></label><label>Position division (%)<input type="number" min="30" max="70" name="<?php echo esc_attr( MSRWA_Settings::FORM_FIELD ); ?>[article_pagination_split_percent]" value="<?php echo esc_attr( $s['article_pagination_split_percent'] ); ?>"></label></div><p class="description">Division WordPress en deux pages à une limite de paragraphe ou de section. Désactivée : article sur une seule page.</p><h3>Images à générer</h3><?php foreach ( array( 'generate_featured_image' => 'Générer l’image principale (Featured)', 'generate_facebook_image' => 'Générer l’image Facebook' ) as $key => $label ) : ?><label><input type="checkbox" name="<?php echo esc_attr( MSRWA_Settings::FORM_FIELD . '[' . $key . ']' ); ?>" value="1" <?php checked( $s[ $key ], 1 ); ?>> <?php echo esc_html( $label ); ?></label><?php endforeach; ?><p class="description">Choix indépendants. Une image désactivée ne déclenche ni génération ni contrôle image. Facebook seul : création depuis la recette, sans image principale. Les choix sont conservés avec chaque nouveau job.</p></section><div class="msrwa-card" id="msrwa-settings-quality"><h2>Contrat qualité</h2><p class="description">Critères autonomes appliqués à chaque recette.</p><div class="msrwa-fields"><label>Score minimum /100<input type="number" min="1" max="100" name="<?php echo esc_attr( MSRWA_Settings::FORM_FIELD ); ?>[quality_min_score]" value="<?php echo esc_attr( $s['quality_min_score'] ); ?>"></label><label>Mots minimum<input type="number" min="300" max="8000" name="<?php echo esc_attr( MSRWA_Settings::FORM_FIELD ); ?>[quality_min_words]" value="<?php echo esc_attr( $s['quality_min_words'] ); ?>"></label><label>Mots maximum<input type="number" min="500" max="10000" name="<?php echo esc_attr( MSRWA_Settings::FORM_FIELD ); ?>[quality_max_words]" value="<?php echo esc_attr( $s['quality_max_words'] ); ?>"></label><label>Titres h2/h3 minimum<input type="number" min="3" max="80" name="<?php echo esc_attr( MSRWA_Settings::FORM_FIELD ); ?>[quality_min_headings]" value="<?php echo esc_attr( $s['quality_min_headings'] ); ?>"></label><label>Paragraphes minimum<input type="number" min="5" max="150" name="<?php echo esc_attr( MSRWA_Settings::FORM_FIELD ); ?>[quality_min_paragraphs]" value="<?php echo esc_attr( $s['quality_min_paragraphs'] ); ?>"></label><label>Ingrédients indicatifs<input type="number" min="1" max="50" name="<?php echo esc_attr( MSRWA_Settings::FORM_FIELD ); ?>[quality_min_ingredients]" value="<?php echo esc_attr( $s['quality_min_ingredients'] ); ?>"></label><label>Étapes indicatives<input type="number" min="1" max="40" name="<?php echo esc_attr( MSRWA_Settings::FORM_FIELD ); ?>[quality_min_steps]" value="<?php echo esc_attr( $s['quality_min_steps'] ); ?>"></label><label>Sortie article max (tokens)<input type="number" min="1000" max="20000" name="<?php echo esc_attr( MSRWA_Settings::FORM_FIELD ); ?>[article_max_output_tokens]" value="<?php echo esc_attr( $s['article_max_output_tokens'] ); ?>"></label><label>Sortie relecture max (tokens)<input type="number" min="500" max="10000" name="<?php echo esc_attr( MSRWA_Settings::FORM_FIELD ); ?>[review_max_output_tokens]" value="<?php echo esc_attr( $s['review_max_output_tokens'] ); ?>"></label></div><p class="description">Contrat actuel : <?php echo esc_html( number_format_i18n( $benchmark['words'] ) ); ?> mots, <?php echo esc_html( number_format_i18n( $benchmark['headings'] ) ); ?> titres et <?php echo esc_html( number_format_i18n( $benchmark['paragraphs'] ) ); ?> paragraphes minimum.</p></div>
