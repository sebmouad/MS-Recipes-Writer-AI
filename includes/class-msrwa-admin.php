...
final class MSRWA_Admin {
	...
	public static function settings_page() {
		...
		<div class="msrwa-card"><h2>Budget de test</h2><label><input type="checkbox" name="<?php echo esc_attr( MSRWA_Settings::OPTION ); ?>[allow_paid_tests]" value="1" <?php checked( $s['allow_paid_tests'], 1 ); ?>> Autoriser les appels API payants de test</label><label>Budget maximal des tests (USD)<input type="number" min="0" max="1000" step="0.01" name="<?php echo esc_attr( MSRWA_Settings::OPTION ); ?>[test_budget_usd]" value="<?php echo esc_attr( $s['test_budget_usd'] ); ?>"></label><p class="description">Désactivé par défaut. Ce réglage autorise seulement les tests locaux ; il ne garantit pas une limite absolue de facturation fournisseur.</p></div>
