...
final class MSRWA_DB {
	...
	public static function install() {
		...
		$t = self::tables();
		$sql = array(
			"CREATE TABLE {$t['batches']} (id bigint(20) unsigned NOT NULL AUTO_INCREMENT, owner_id bigint(20) unsigned NOT NULL, status varchar(32) NOT NULL DEFAULT 'queued', total int unsigned NOT NULL DEFAULT 0, completed int unsigned NOT NULL DEFAULT 0, created_at datetime NOT NULL, updated_at datetime NOT NULL, PRIMARY KEY (id), KEY owner_status (owner_id,status), KEY created_at (created_at)) $charset;",
			"CREATE TABLE {$t['jobs']} (id bigint(20) unsigned NOT NULL AUTO_INCREMENT, batch_id bigint(20) unsigned NOT NULL, owner_id bigint(20) unsigned NOT NULL, title text NOT NULL, input_json longtext NULL, canonical_json longtext NULL, status varchar(32) NOT NULL DEFAULT 'queued', stage varchar(64) NOT NULL DEFAULT 'intake', correction_cycles tinyint unsigned NOT NULL DEFAULT 0, attempts tinyint unsigned NOT NULL DEFAULT 0, error_code varchar(80) NULL, error_message text NULL, lock_token varchar(64) NULL, lock_until datetime NULL, created_at datetime NOT NULL, updated_at datetime NOT NULL, PRIMARY KEY (id), KEY batch_status (batch_id,status), KEY owner_status (owner_id,status), KEY lock_until (lock_until)) $charset;",
